        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @endif
                    <x-nav-link :href="route('curiosidades.index')" :active="request()->routeIs('curiosidades.index')">
                        {{ __('Curiosidades') }}
                    </x-nav-link>
                    <x-nav-link :href="route('innovaciones.index')" :active="request()->routeIs('innovaciones.index')">
                        {{ __('Innovaciones') }}
                    </x-nav-link>
                    <x-nav-link :href="route('biografia-eventos.index')" :active="request()->routeIs('biografia-eventos.index')">
                        {{ __('Biografía') }}
                    </x-nav-link>
                </div>
            </div>
