        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')" class="text-gray-300 hover:text-white">Inicio</x-nav-link>
                    <x-nav-link :href="route('innovaciones.index')" :active="request()->routeIs('innovaciones.*')" class="text-gray-300 hover:text-white">Innovaciones</x-nav-link>
                    <x-nav-link :href="route('curiosidades.index')" :active="request()->routeIs('curiosidades.*')" class="text-gray-300 hover:text-white">Curiosidades</x-nav-link>
