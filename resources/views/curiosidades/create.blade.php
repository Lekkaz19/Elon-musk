<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-100 leading-tight">Crear Curiosidad</h2></x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 border border-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.curiosidades.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div><label class="block text-sm font-medium text-gray-300">Contenido</label><textarea name="content" rows="4" class="mt-1 block w-full bg-gray-900 border-gray-600 text-white rounded-md" required></textarea></div>
